...
If we recall that $\delta = \frac{\pi}{2}$ at resonance, substitution of this value into Equation \@ref(eq:ch5-oscillatorenergy4) tells us that the maximum energy is transferred to the oscillator when driven at a resonant frequency - in line with our expectations.
...
As before, we have the result that $v = -\omega A \sin(\omega t - \delta)$ (Equation \@ref(eq:ch5-oscillatorenergy2)), and following through the integration in a similar manner as in the previous section we are led to the result in Equation \@ref(eq:ch5-oscillatorenergy6) for a **driven damped oscillator** at **steady state**.
